...
function typeWriter() {
  if (i < txt1.length) {        
     if(txt1.charAt(i)=='<')
      ...
      {
        $(".bg_heart").css("background-image","url('https://www.lovedignity.com/wp-content/uploads/2015/11/pictures-of-love-quotes-in-love-quotes-background-hd-wallpaper-of-love-61466.jpg')");
